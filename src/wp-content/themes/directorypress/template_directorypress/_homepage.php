...
<?php /*---------------------------- HOME PAGE CATEGORIES DISPLAY ----------------------------------------- */
    ...
    <div class="itembox">
        ...
        <h2 id="icon-home-custombox<?php echo $t; ?>"><?php echo stripslashes(get_option("home_custombox_".$t."_title")); ?></h2>
		 ...
		 case "featured1": {
			...
			$FeaturedListings = query_posts('posts_per_page=5&meta_key=featured&meta_value=yes');
